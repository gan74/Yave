...
bool isImageType(UniformType type) {
	static constexpr GLenum images[] = {
		GL_IMAGE_1D,
		GL_IMAGE_2D,
		GL_IMAGE_3D,
		GL_IMAGE_2D_RECT,
...
GLenum shaderType[] = {GL_FRAGMENT_SHADER, GL_VERTEX_SHADER, GL_GEOMETRY_SHADER, GL_COMPUTE_SHADER};
...
GLenum intParams[] = {GL_MAX_DRAW_BUFFERS, GL_MAX_TEXTURE_IMAGE_UNITS, GL_MAX_VERTEX_ATTRIBS, GL_MAX_VARYING_VECTORS, GL_MAX_UNIFORM_BLOCK_SIZE, GL_MAX_SHADER_STORAGE_BLOCK_SIZE, GL_MAJOR_VERSION, GL_MINOR_VERSION, GL_MAX_COMPUTE_WORK_GROUP_INVOCATIONS};
...
GLenum textureAccess[] = {GL_READ_WRITE, GL_WRITE_ONLY, GL_READ_ONLY};
...
Handle boundImages[MaxBindings] = {0};
