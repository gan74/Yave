...
class ShaderInstance : public ShaderInstanceBase
{
	public:
		...
		void bind() { ShaderInstanceBase::bind(); }
		void rebind() { ShaderInstanceBase::rebind(); }
		void unbind() { ShaderInstanceBase::unbind(); }
